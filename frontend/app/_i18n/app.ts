...
const appStrings = {
  ...
  forgotLink: "Sifremi unuttum",
  forgotTitle: "Sifre sifirlama",
  forgotSubtitle: "Hesabinizin e-posta adresini girin; kayitliysa bir sifirlama linki gonderilir.",
  forgotSubmit: "Sifirlama linki gonder",
  forgotSent: "Bu adres kayitliysa bir sifirlama linki gonderildi. Gelen kutunuzu kontrol edin.",
  forgotBackToLogin: "Girise don",
  resetTitle: "Yeni sifre belirleyin",
  resetPassword: "Yeni sifre (en az 8 karakter)",
  resetSubmit: "Sifreyi degistir",
  resetDone: "Sifreniz degistirildi. Simdi giris yapabilirsiniz.",
  resetInvalid: "Bu link gecersiz veya suresi dolmus. Yeni bir tane isteyin.",
  resetThrottled: "Cok fazla deneme. Lutfen biraz bekleyin.",
